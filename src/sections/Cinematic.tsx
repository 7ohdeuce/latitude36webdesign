    ...
    <section ref={sectionRef} className="relative h-screen h-[100dvh] overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-full px-6 text-center">
        <motion.div style={{ transform, opacity }}>
          <p className="text-xs sm:text-sm tracking-[0.35em] uppercase text-white/60 mb-6">
            AI-Generated Cinema
          </p>
          ...
          <p className="mt-8 text-sm sm:text-base text-white/70 max-w-2xl mx-auto leading-relaxed">
